...
module_load_include('php', 'cel_5d_course_registration', 'entities/purchaser');

/**
 * Entity builder for Purchaser object
 * 
 * @author vparfaniuc
 *        
 *        
...
class PurchaserBuilder  {
	...
	private $entity_title = 'Purchaser';
	 ...
	 * @return Ambigous <Purchaser, boolean>
	 */
	private function run_needed_internal_method($income_vals, $entityObj)
	{
		...
		}elseif (is_array($income_vals) && !empty($income_vals)){
	 ...
	 * @param Purchaser incomeGenericObjObj
	 * @return Purchaser
	 */
	private function build_entity_object_based_on_incoming_object_data($incomeGenericObj, Purchaser $entityObj)
	{
	 ...
	 * @param Purchaser entityObj
	 * @return Purchaser
	 */
	private function build_entity_object_based_on_incoming_array_data(array $income_array, Purchaser $entityObj)
	{
