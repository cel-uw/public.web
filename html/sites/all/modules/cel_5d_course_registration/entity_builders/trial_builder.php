...
module_load_include('php', 'cel_5d_course_registration', 'entities/trial');

/**
 * Entity builder for Trial object
 * 
 * @author vparfaniuc
 *        
 *        
...
class TrialBuilder  {
	 ...
	 * @param Trial entityObj
	 * @return Trial
	 */
	private function build_entity_object_based_on_incoming_array_data(array $income_array, Trial $entityObj)
	{
	 ...
	 * @param Trial incomeGenericObjObj
	 * @return Trial
	 */
	private function build_entity_object_based_on_incoming_object_data($incomeGenericObj, Trial $entityObj)
	{
	 ...
	 * @return Trial
	 */
	private function fill_entity_object_with_incoming_array_data(array $income_array, Trial $entityObj)
	{
		// validate entity methods and income array
		if(!$this->entity_methods || !is_array($this->entity_methods) || empty($income_array)){
			return FALSE;
