...
<?php endif; ?>
 ...
 <?php if ($node->og_groups && $page) {
          print '<div class="groups">'. t('Course');
          //change group link to group dashboard view
          $dashboard_links = $og_links['raw'];
          $dashboard_links['og_36']['href'] = str_replace('node','groupdash',$dashboard_links['og_36']['href']);
          print '<div class="links">'.  theme('links',$dashboard_links). '</div></div>';
   } ?>
  <div class="content">
    <?php print $content ?>
  </div>
