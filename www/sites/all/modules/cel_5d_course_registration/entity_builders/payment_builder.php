...
module_load_include('php', 'cel_5d_course_registration', 'entities/payment');

/**
 * Entity builder for Payment object
 * 
 * @author vparfaniuc
 *        
 *        
...
class PaymentBuilder  {
	 ...
	 * @return Ambigous <Payment, boolean>
	 */
	 ...
	 * @param Payment entityObj
	 * @return Payment
	 */
	private function build_entity_object_based_on_incoming_array_data(array $income_array, Payment $entityObj)
	{
	 ...
	 * @param Payment incomeGenericObjObj
	 * @return Payment
	 */
	private function build_entity_object_based_on_incoming_object_data($incomeGenericObj, Payment $entityObj)
	{
	 ...
	 * @return Payment
	 */
	private function fill_entity_object_with_incoming_array_data(array $income_array, Payment $entityObj)
	{
		// validate entity methods and income array
		if(!$this->entity_methods || !is_array($this->entity_methods) || empty($income_array)){
			return FALSE;
