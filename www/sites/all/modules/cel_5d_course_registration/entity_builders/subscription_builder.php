...
module_load_include('php', 'cel_5d_course_registration', 'entities/subscription');

/**
 * Entity builder for Subscription object
 * 
 * @author vparfaniuc
 *        
 *        
...
class SubscriptionBuilder  {
	...
	private $entity_title = 'Subscription';
...
// fuse_debug2($income_vals);
	 ...
	 * @return Ambigous <Subscription, boolean>
	 */
	 ...
	 * @param Subscription entityObj
	 * @return Subscription
	 */
	private function build_entity_object_based_on_incoming_array_data(array $income_array, Subscription $entityObj)
	{
	 ...
	 * @param Subscription incomeGenericObjObj
	 * @return Subscription
	 */
	private function build_entity_object_based_on_incoming_object_data($incomeGenericObj, Subscription $entityObj)
	{
	 ...
	 * @return Subscription
	 */
	private function fill_entity_object_with_incoming_array_data(array $income_array, Subscription $entityObj)
	{
		// validate entity methods and income array
		if(!$this->entity_methods || !is_array($this->entity_methods) || empty($income_array)){
			return FALSE;
